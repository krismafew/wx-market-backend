...
public interface MarketOrderMapper {
    ...
    Integer countUnpaidOrdersByUsername(@Param("username") String principal);

    Integer countUnshipOrdersByUsername(@Param("username") String principal);

    Integer countUnreceivedOrdersByUsername(@Param("username") String principal);

    Integer countUncommentOrdersByUsername(@Param("username") String principal);
}